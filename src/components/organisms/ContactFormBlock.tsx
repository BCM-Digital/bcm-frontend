import { ContactDetails, ContactFormBlock as ContactFormBlockType } from '@types'
		...
		<Section className={classes} htmlId={anchorId}>
			<Corridor>
				<Grid>
						...
						<div className="col-span-full space-y-4 tablet:space-y-6 tablet-landscape:col-span-4 laptop:col-span-3">
							...
							{contact?.businessHours && contact.businessHours.length > 0 && (
								<Widget
									className="text-accent"
									title="Opening hours">
									<ul className="text-dark space-y-3">
					...
					<div
						className="col-span-full space-y-4 tablet:space-y-6 tablet-landscape:col-span-7 tablet-landscape:col-start-6 laptop:col-span-6 laptop:col-start-5">
