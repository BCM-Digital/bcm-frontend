...
function TabsBlock({
	...
	return (
		<Section className={classes} htmlId={anchorId}>
			<Corridor>
				<div className="border-b border-solid border-dark-100" role="tablist">
					<div className="relative no-scrollbar -mb-5 overflow-x-auto overflow-y-hidden whitespace-nowrap pb-5 laptop:whitespace-normal">
