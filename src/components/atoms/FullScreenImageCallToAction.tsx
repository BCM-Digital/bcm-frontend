...
function FullScreenImageCallToAction({
	...
	const classes = clsx('@container relative text-white h-screen-11/12 overflow-hidden tablet:h-svh', className)
		...
		<article className={classes}>
			...
			<div className={contentClasses}>
				<Corridor className="relative z-10 flex flex-col">
					<Grid>
						<div className="col-span-full space-y-6 tablet:col-span-6 tablet-landscape:col-span-8 laptop:col-start-2 laptop:col-span-7">
...
export type {
	FullScreenImageCallToActionProps
}
